...
public class Board {
    ...
    private String category;//실제로 board테이블에 저장된 테이터는 category_no지만 조회시 카테고리명으로 조회할것(문자열)
    private String boardTitle;
    private String boardContent;
    private String boardWriter;//실제로 저장된 데이터는 user_no지만 조회시 회원아이디로 조회할것(문자열)
    private int count;
    ...
    public Board(int boardNo, int boardType, String category, String boardTitle, String boardContent, String boardWriter, int count, Date createDate, String status, String titleImg) {
